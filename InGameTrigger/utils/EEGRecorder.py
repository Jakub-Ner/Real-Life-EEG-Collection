...
class EEGRecorder:
    ...
    def background_record(self, key: str):
        ...
        `recording_before` lasts 0.1s less to ensure it finished before `recording_after` starts.
        """
        ...
        recording_after_thread = threading.Thread(target=listen_udp, args=(f'{DATA_PATH}/{current_name}', self.state_duration))
